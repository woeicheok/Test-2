   ...
   class Income {
    ...
    class Staff {
      ...
      void displayIncomeInfo() {
         ...
         System.out.println("Staff Income Amount: " + income.getincomeAmount());
         System.out.println("Staff Income Tax Percentage: " + income.getincomeTax());
         System.out.println("Staff Income Total Tax: " + income.getTotalTax());
         System.out.println("Staff Net Income: " + calculateNetIncome());
       }
   }